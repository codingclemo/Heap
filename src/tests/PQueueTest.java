...
public class PQueueTest {
	...
	public static void BinaryHeapTests(){
		System.out.println("*************\tBinaryHeap Tests\t*************");
	...
	public static void DHeapTests(){
		System.out.println("*************\tDHeap Tests\t*************");
		DHeapQueue<Integer> d = new DHeapQueue<Integer>();
	}
